export type SolanaNftProgramsPaidClaimApprover = {
  version: "4.6.0";
  name: "solana_nft_programs_paid_claim_approver";
  instructions: [
    {
      name: "init";
      accounts: [
    ...
    },
    {
      ...
      accounts: [
        ...
        {
          name: "solanaNftProgramsTokenManager";
          isMut: false;
          isSigner: false;
        },
        {
...
export const IDL: SolanaNftProgramsPaidClaimApprover = {
  version: "4.6.0",
  name: "solana_nft_programs_paid_claim_approver",
  instructions: [
    {
