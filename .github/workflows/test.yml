...
jobs:
  ...
  integration-tests:
    ...
    steps:
      ...
      - run: find . -type f -name "*" -exec sed -i'' -e "s/pmBbdddvcssmfNgNfu8vgULnhTAcnrn841K5QVhh5VV/$(solana-keygen pubkey tests/test-keypairs/cardinal_payment_manager-keypair.json)/g" {} +
